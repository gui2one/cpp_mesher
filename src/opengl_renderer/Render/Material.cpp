...
{
    m_Shader = std::make_shared<Shader>("Resources/Shaders/basic_shader.vert", "Resources/Shaders/basic_shader.frag");
...
{
    m_Shader = std::make_shared<Shader>("Resources/Shaders/irradiance/2.2.2.pbr.vs", "Resources/Shaders/irradiance/2.2.2.pbr.fs");
