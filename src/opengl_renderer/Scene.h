...
namespace GLR
{
    ...
    public:
        ...
        void Add(std::shared_ptr<Font2dObject> text2d);
        ...
        std::vector<std::shared_ptr<Font2dObject>> GetFont2dObjects() const { return m_Font2dObjects; } 
    ...
    private:
        ...
        std::vector<std::shared_ptr<Font2dObject>> m_Font2dObjects;
